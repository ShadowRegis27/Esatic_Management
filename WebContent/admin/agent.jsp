		...
		<div class="row">
			<div class="col-md-5 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-3 text-center">Ajouter Agent</p>
						...
						<form action="../addAgent" method="post">
							...
							<div class="mb-3">
								<label class="form-label">Date de Naissance</label> <input type="date"
									required name="date_de_naissance_agent" class="form-control">
							</div>

							<div class="mb-3">
								<label class="form-label">Matricule</label> <input required
									name="matricule_agent" type="text" class="form-control">
							</div>
							<div class="mb-3">
								<label class="form-label">Mot de passe</label> <input required
									name="mot_de_passe_agent" type="password" class="form-control">
							</div>
